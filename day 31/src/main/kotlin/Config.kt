...
/**
 * Конфигурация Дня 31 — ассистент разработчика.
 *
 * Ключ DeepSeek ищется как в Днях 28–30: сначала окружение и локальный .env,
